                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0">
                                        ...
                                        <div class="d-flex justify-content-between recent-emails">
                                            <div class="d-flex">
                                                <div class="profile-k">
                                                    <img src="{{ asset('asset/images/profile/small/pic6.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3">
                                        ...
                                        <div class="d-flex justify-content-between recent-emails">
                                            <div class="d-flex">
                                                <div class="profile-k">
                                                    <img src="{{ asset('asset/images/profile/small/pic8.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3">
                                                    <h4 class="fs-18 font-w500">How to improve project management flows</h4>
                                                    <span class="font-w400 d-block">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do<br> eiusmod tempor incididunt ut labore et dolore magna aliqua...</span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box">
                                                    <img src="{{ asset('asset/images/profile/small/pic7.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('asset/images/profile/small/pic3.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('asset/images/profile/small/pic5.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
